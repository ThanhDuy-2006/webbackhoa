...
import { Package, Users, ShoppingBag, LayoutDashboard, Settings, CreditCard, LogOut, Tags, Search, Bell, Calendar, ChevronDown, Ticket, BarChart3, Archive, UserCog } from 'lucide-react'
  ...
  return (
    <div className="flex h-screen bg-[#F5F7FB] overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Topbar */}
        <header className="h-20 flex items-center px-8 justify-end shrink-0 mt-4 mx-4 bg-white/50 backdrop-blur-md rounded-2xl border border-white/40 shadow-[0_4px_24px_-12px_rgba(0,0,0,0.05)]">
